        ...
        <div>
            ...
            <div className="flex flex-row justify-center p-10 mb-5 xl:gap-x-28 lg:gap-x-16 md:gap-x-8">
                ...
                <div className="flex flex-col justify-center ">
                    <div className="flex flex-row float-start items-center pb-10 
            ...
            <div className="bg-orgnizerbg-light  text-center text-text-light absolute   drop-shadow-[2px_2px_rgba(9,133,94,0.6)] 
             xl:rounded xl:left-44 xl:w-56 xl:h-10 xl:top-60 
             lg:rounded-md lg:left-40 lg:w-48 lg:h-8 lg:top-60
             md:rounded-sm md:left-36  md:w-44 md:h-8 md:top-56 ">
                <span className="xl:text-3xl lg:text-2xl md:text-xl font-['serif']">Financial Details</span>
            </div>
            <div className="bg-orgnizerbg-light  text-center text-text-light absolute   drop-shadow-[2px_2px_rgba(9,133,94,0.6)] 
             xl:rounded xl:right-96 xl:w-56 xl:h-10 xl:top-36 
             lg:rounded-md lg:right-80 lg:w-48 lg:h-8 lg:top-36
             md:rounded-sm md:right-72  md:w-44 md:h-8 md:top-32 ">
